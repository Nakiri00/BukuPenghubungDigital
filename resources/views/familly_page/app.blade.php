        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="">
                        <i class="fab fa-fw fa-wpforms"></i>
                        <span>View Students Result</span>
                    </a>
                </li> -->
                <li class="nav-item">
                    <a class="nav-link" href="{{route('family_student_form')}}">
                        <i class="fab fa-fw fa-wpforms"></i>
                        <span>Isi Data Murid</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('family_view_student_result')}}">
                        <i class="fab fa-fw fa-wpforms"></i>
                        <span>Lihat Kegiatan siswa</span>
                    </a>
                </li>
