...
<head>
    ...
    <title>School Manement and counciling - Dashboard</title>
    ...
    <div id="app">
        <div id="wrapper">
            ...
            <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('conciliar_dashboard.create')}}">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('conciliar_dashboard.comments')}}">
                        <i class="fab fa-fw fa-wpforms"></i>
                        <span>View Teacher Request</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('students_comment.create')}}">
                        <i class="fab fa-fw fa-wpforms"></i>
