    ...
    <div class="card text-left col-md-12">
        ...
        <div class="card text-left">
            ...
            <div class="card-body">
                ...
                @endif
                <form method="post" action="{{route('student_result.update', $student_result)}}" class="form-horizontal"
                    ...
                    <div class="form-group  required">
                        ...
                        <div class="input-group">
                            <select name="grade_id" id="grade_id"
                                ...
                                <option value="{{$grade->id}}" {{$student_result->grade_id == $grade->id ? 'selected' : ''}}>
                                    {{$grade->grade}}
                                </option>
                        ...
                        <div class="input-group">
                            <select name="student_id" id="student_id"
                                ...
                                <option value="{{$student->id}}"
                                    {{$student_result->student_id == $student->id ? 'selected' : ''}}>
                                    {{$student->name}}
                                </option>
                        ...
                        <div class="input-group">
                            <select name="subject_id" id="subject_id"
                                ...
                                <option value="{{$subject->id}}"
                                    {{$student_result->subject_id == $subject->id ? 'selected' : ''}}>
